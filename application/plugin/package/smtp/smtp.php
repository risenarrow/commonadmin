 ...
 * Time: 9:01
 */
namespace app\plugin\package\smtp;
...
class smtp
{
  ...
  function __construct($param=[])
  {
    ...
    $this->debug   = intval($param['debug'])?true:false;
    $this->smtp_port = $param['smtpserverport'];
    $this->relay_host = $param['smtpserver'];
    $this->time_out  = 30; //is used in fsockopen()
    $this->smtpusermail = $param['smtpusermail'];
    #
    $this->auth    = true; //auth
    $this->user    = $param['smtpuser'];
    $this->pass    = $param['smtppass'];
    #
   ...
   * @return bool
   */
  function sendmail($to, $subject = "", $body = "", $mailtype='HTML', $cc = "", $bcc = "", $additional_headers = "")
  {
    $header  = "";
    $from = $this->smtpusermail;
...
//  }
  ...
  public function afterInstall($param = []){

  }

  public  function afterUninstall($param=[]){
