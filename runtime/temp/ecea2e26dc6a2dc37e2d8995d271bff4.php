<?php /*a:2:{s:71:"K:\CODE\php\site\commonadmin\application\admin\view\adminuser\edit.html";i:1654132782;s:70:"K:\CODE\php\site\commonadmin\application\admin\view\public\layout.html";i:1654065083;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			    ...
			    <form class="layui-form" action="">
			      <div class="layui-form-item">
			        ...
			        <div class="layui-input-inline">
			          <input type="text" name="admin_name" lay-verify="required|enverify" autocomplete="off" placeholder="请输入管理员账号" class="layui-input" value="<?php echo htmlentities($data['admin_name']); ?>">
			        </div>
				    ...
				    <div class="layui-input-inline">
				      <select name="role_id" lay-verify="required" >
                          <?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): if( count($role_list)==0 ) : echo "" ;else: foreach($role_list as $key=>$item): if($key != 1): ?>
				            <option value="<?php echo htmlentities($key); ?>" <?php if($key == $data['role_id']): ?>select=""<?php endif; ?>><?php echo htmlentities($item['role_name']); ?></option>
                            <?php endif; ?>
                           <?php endforeach; endif; else: echo "" ;endif; ?>
				      </select>
				    </div>
...
<script>
    var addurl = '<?php echo admin_url("admin/adminuser/edit"); ?>';
